...
public class ChessBoard {
    ...
    static Rook bRook1 = new Rook("black", charToX('a'), 8);//a8
    static Rook bRook2 = new Rook("black", charToX('h'), 8);//h8
    static Knight wKnight1 = new Knight("white", charToX('b'), 1);//b1
    static Knight wKnight2 = new Knight("white", charToX('g'), 1);//g1
    static Knight bKnight1 = new Knight("black", charToX('b'), 8);//b8
    static Knight bKnight2 = new Knight("black", charToX('g'), 8);//g8
    static Bishop wBishop1 = new Bishop("white", charToX('c'), 1);//c1
    static Bishop wBishop2 = new Bishop("white", charToX('f'), 1);//f1
    static Bishop bBishop1 = new Bishop("black", charToX('c'), 8);//c8
    static Bishop bBishop2 = new Bishop("black", charToX('f'), 8);//f8
    static Pawn wPawn1 = new Pawn("white", charToX('a'), 2);//a2
    static Pawn wPawn2 = new Pawn("white", charToX('b'), 2);//b2
    static Pawn wPawn3 = new Pawn("white", charToX('c'), 2);//c2
    static Pawn wPawn4 = new Pawn("white", charToX('d'), 2);//d2
    ...
    static Pawn wPawn8 = new Pawn("white", charToX('h'), 2);//h2
    static Pawn bPawn1 = new Pawn("black", charToX('a'), 7);//a7
    static Pawn bPawn2 = new Pawn("black", charToX('b'), 7);//b7
